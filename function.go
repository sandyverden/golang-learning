// Functions are central in Go. We'll lean about functions with a few different example
...
// There are several other feature to Go functions. One is multiple return value, which we'll look at next
